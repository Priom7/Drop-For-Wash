...
if( isset($_POST['submit']) ) 
{
    ...
    {
        $stmt = $conn->prepare("UPDATE `branch` SET `branchName`=:branch WHERE  `branchID`=$id");
        $stmt->bindParam(':branchName',$_POST['topicname']);
						...
						<div class="panel">
							...
							<div class="content">
								...
								<dl>
									...
									<dd><input type="text" tabindex="1" name="topicname" value="<?php echo $topicname; ?>" id="" size="25" value="" class="inputbox autowidth" placeholder="Topic name"></dd>
								</dl>
								<dl>
									<dt><label for="description">Description</label></dt>
									<dd><input type="text" tabindex="1" name="description" value="<?php echo $description; ?>" id="description" size="25" value="" class="inputbox autowidth" placeholder='Description'><br>
...
foreach ($Building as $data) {
    ...
    echo '<tr><td>'.$s++.'</td><td>'.$topicname.'</td><td>'.$date.'</td>
          <td><a href="edittopic.php?topicID='.$topicID.'" class="btn btn-info m-l-20 waves-effect waves-light" style="color:#ffffff">Edit</a>
